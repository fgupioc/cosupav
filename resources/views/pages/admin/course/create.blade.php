...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
           <form accept="{{ route('courses.store') }}" method="POST" enctype="multipart/form-data">
                 @csrf
                 <div class="row">
                          ...
                          <div class="col-12">
                              <div class="form-group">
                                  ...
                                  <textarea class="textarea" id="to_learn" name="to_learn" placeholder="Place some text here"
                                            style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ old('title') }}</textarea>
                              </div>
                          </div>
                          <div class="col-12">
                              <div class="form-group">
                  ...
                  <div class="col-12 col-md-4">
                      <div class="form-group">
                          ...
                          <div class="div" style="cursor: pointer">
                              <img src="{{ asset('img/default.jpg') }}" id="output" style="width: 100%; object-fit: cover" onclick="$('#file').click()">
                          </div>
